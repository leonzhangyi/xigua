...
import com.water.melon.ui.game.utils.CustomViews;
import com.water.melon.ui.game.utils.OnItemClickListener;
...
public class PlayGameFragment extends Fragment {
    ...
    private CustomViews mBackImageView;
    ...
    public static PlayGameFragment getInstance(Bundle bundle) {

        PlayGameFragment mPlayGameFragment = new PlayGameFragment();
        if (bundle != null) {
            mPlayGameFragment.setArguments(bundle);
        }

        return mPlayGameFragment;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_agent_web_1, container, false);
    }
...
//		mAgentWeb.getWebCreator().getWebView().setOnLongClickListener();
    ...
    public String getUrl() {
        String target = "";
//        target = AppConfig.getGameUrl(getContext()) + "?token=" + AppConfig.getGameToken(getContext());

        if (TextUtils.isEmpty(target = this.getArguments().getString(URL_KEY))) {
            target = SharedPreferencesUtil.getInstance().getString(SharedPreferencesUtil.XG_GAME_URL, NetConstant.XG_GAME_URL) + "?token=" + SharedPreferencesUtil.getInstance().getString(SharedPreferencesUtil.XG_GAME_TOKEN, "");
        }
        LogUtil.e("loginPlayGame  ", "target = " + target);
//        target = "https://mobiletal.cgdemotest.com";
//		return "http://ggzy.sqzwfw.gov.cn/WebBuilderDS/WebbuilderMIS/attach/downloadZtbAttach.jspx?attachGuid=af982055-3d76-4b00-b5ab-36dee1f90b11&appUrlFlag=sqztb&siteGuid=7eb5f7f1-9041-43ad-8e13-8fcb82ea831a";
    ...
    protected com.just.agentweb.WebViewClient mWebViewClient = new com.just.agentweb.WebViewClient() {
        ...
        public boolean shouldOverrideUrlLoading(WebView view, WebResourceRequest request) {
            Log.e("PlayGameFragment", "shouldOverrideUrlLoading:");
        ...
        public WebResourceResponse shouldInterceptRequest(WebView view, WebResourceRequest request) {
            Log.e("PlayGameFragment", "WebResourceResponse:");
        ...
        public void onPageStarted(WebView view, String url, Bitmap favicon) {
            Log.e("PlayGameFragment", "onPageStarted:");
        ...
        public void onPageFinished(WebView view, String url) {
            ...
            Log.e("PlayGameFragment", "onPageFinished:");
	   ...
	   /* public void onMainFrameError(AbsAgentWebUIController agentWebUIController, WebView view, int errorCode, String description, String failingUrl) {
            ...
            Log.i(TAG, "PlayGameFragment onMainFrameError");
...
//        mAgentWeb.uploadFileResult(requestCode, resultCode, data);
    ...
    protected void initView(View view) {
        mBackImageView = view.findViewById(R.id.custome);
...
//        mBackImageView.setOnClickListener(mOnClickListener);
        mBackImageView.setListener(new OnItemClickListener() {
            @Override
            public void onItemClick(int position) {
                DialogUtil.showDialog(getContext(), "提示", "确定要退出游戏吗？", true, new DialogUtil.SimpleCallback() {
                    @Override
...
//                    intent.putExtra(PlayGameFragment.URL_KEY, XGUtil.getCurrentRoad(0) + mAgentWeb.getWebCreator().getWebView().getUrl());
