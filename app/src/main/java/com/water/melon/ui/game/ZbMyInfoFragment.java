...
public class ZbMyInfoFragment extends Fragment {
    ...
    public static final String TAG = ZbMyInfoFragment.class.getSimpleName();
    private MiddlewareWebClientBase mMiddleWareWebClient;
    private MiddlewareWebChromeBase mMiddleWareWebChrome;

    public static ZbMyInfoFragment getInstance(Bundle bundle) {

        ZbMyInfoFragment mZbMyInfoFragment = new ZbMyInfoFragment();
        if (bundle != null) {
            mZbMyInfoFragment.setArguments(bundle);
        }

        return mZbMyInfoFragment;

    }


    public ZbMyInfoFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_agentweb_info, container, false);
    }
...
//		mAgentWeb.getWebCreator().getWebView().setOnLongClickListener();
    ...
    public String getUrl() {
        String target = "";
        target = SharedPreferencesUtil.getInstance().getString(SharedPreferencesUtil.XG_GAME_URL, NetConstant.XG_GAME_URL) + "/member" + "?token=" + SharedPreferencesUtil.getInstance().getString(SharedPreferencesUtil.XG_GAME_TOKEN, "");

        LogUtil.e("member", "target = " + target);
//        target = "https://www.baidu.com";
    ...
    public void onHiddenChanged(boolean hidden) {
        ...
        if (hidden == false && (((System.currentTimeMillis()) - lastTime) > 3 * 1000)) {
            LogUtil.e("onHiddenChanged", "info");
            lastTime = System.currentTimeMillis();
            doCheckToken();
        }
    }
        ...
        HttpHelper.loginPlayGame(new GamePlayCallBack() {
            ...
            public void onResponse(com.water.melon.ui.game.utils.GameBean response, int id) {
                ...
                if (response != null && response.getResult() != null) {
                    ...
                    if (mAgentWeb != null) {
                        mAgentWeb.getUrlLoader().loadUrl(SharedPreferencesUtil.getInstance().getString(SharedPreferencesUtil.XG_GAME_URL, NetConstant.XG_GAME_URL) + "/member" + "?token=" + gameToke);
                    }
    ...
    protected com.just.agentweb.WebViewClient mWebViewClient = new com.just.agentweb.WebViewClient() {
	   ...
	   /* public void onMainFrameError(AbsAgentWebUIController agentWebUIController, WebView view, int errorCode, String description, String failingUrl) {
            ...
            Log.i(TAG, "ZbMyInfoFragment onMainFrameError");
...
//        mAgentWeb.uploadFileResult(requestCode, resultCode, data);
    ...
    protected void initView(View view) {
        ...
        mBackImageView = (ImageView) view.findViewById(R.id.pay_back);
...
//                    // true表示AgentWeb处理了该事件
//                    if (!mAgentWeb.back()) {
//                        ZbMyInfoFragment.this.getActivity().finish();
//                    }
//                    break;
//                case R.id.iv_finish:
//                    ZbMyInfoFragment.this.getActivity().finish();
...
//                    intent.putExtra(ZbMyInfoFragment.URL_KEY, XGUtil.getCurrentRoad(0) + mAgentWeb.getWebCreator().getWebView().getUrl());
...
//                Log.e(TAG, "MiddlewareWebClientBase#shouldOverrideUrlLoading request url:" + request.getUrl().toString());
    ...
    public TextView me_msg_num;
    public ImageView me_chart_view_circle;
