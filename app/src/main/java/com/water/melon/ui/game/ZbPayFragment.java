...
public class ZbPayFragment extends Fragment {
    ...
    public static final String TAG = ZbPayFragment.class.getSimpleName();
    private MiddlewareWebClientBase mMiddleWareWebClient;
    private MiddlewareWebChromeBase mMiddleWareWebChrome;

    public static ZbPayFragment getInstance(Bundle bundle) {

        ZbPayFragment mZbPayFragment = new ZbPayFragment();
        if (bundle != null) {
            mZbPayFragment.setArguments(bundle);
        }

        return mZbPayFragment;

    }


    public ZbPayFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_agentweb_pay, container, false);
    }
...
//		mAgentWeb.getWebCreator().getWebView().setOnLongClickListener();
    ...
    public String getUrl() {
        ...
        target = SharedPreferencesUtil.getInstance().getString(SharedPreferencesUtil.XG_GAME_URL, NetConstant.XG_GAME_URL) + "/deposit" + "?token=" + SharedPreferencesUtil.getInstance().getString(SharedPreferencesUtil.XG_GAME_TOKEN, "");
...
//        target = "https://www.baidu.com";
        ...
        HttpHelper.loginPlayGame(new GamePlayCallBack() {
            ...
            public void onResponse(com.water.melon.ui.game.utils.GameBean response, int id) {
                ...
                if (response != null && response.getResult() != null) {
                    ...
                    if (mAgentWeb != null) {
                        mAgentWeb.getUrlLoader().loadUrl(SharedPreferencesUtil.getInstance().getString(SharedPreferencesUtil.XG_GAME_URL, NetConstant.XG_GAME_URL) + "/deposit" + "?token=" + gameToke);
                    }
    ...
    protected com.just.agentweb.WebViewClient mWebViewClient = new com.just.agentweb.WebViewClient() {
	   ...
	   /* public void onMainFrameError(AbsAgentWebUIController agentWebUIController, WebView view, int errorCode, String description, String failingUrl) {
            ...
            Log.i(TAG, "ZbPayFragment onMainFrameError");
...
//                    intent.putExtra(ZbPayFragment.URL_KEY, XGUtil.getCurrentRoad(0) + mAgentWeb.getWebCreator().getWebView().getUrl());
