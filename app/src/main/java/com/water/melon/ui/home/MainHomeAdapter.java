...
public class MainHomeAdapter extends BaseQuickAdapter<HomeBean, BaseViewHolder> {
    ...
    @Override
    protected void convert(@NonNull BaseViewHolder helper, final HomeBean item) {
        ...
        home_fragment_item_tv.setText(item.getName());
        GlideHelper.showRoundImageNoStroke(home_fragment_item_iv, item.getIcon(), R.mipmap.ic_launcher_round);
