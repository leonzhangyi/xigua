...
public class WelfWebFragment extends Fragment implements FragmentKeyDown {
    ...
    public static final String TAG = WelfWebFragment.class.getSimpleName();
    private MiddlewareWebClientBase mMiddleWareWebClient;
    private MiddlewareWebChromeBase mMiddleWareWebChrome;

    public static WelfWebFragment getInstance(Bundle bundle) {

        WelfWebFragment mWelfWebFragment = new WelfWebFragment();
        if (bundle != null) {
            mWelfWebFragment.setArguments(bundle);
        }

        return mWelfWebFragment;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_welweb, container, false);
    }
...
//		return "http://ggzy.sqzwfw.gov.cn/WebBuilderDS/WebbuilderMIS/attach/downloadZtbAttach.jspx?attachGuid=af982055-3d76-4b00-b5ab-36dee1f90b11&appUrlFlag=sqztb&siteGuid=7eb5f7f1-9041-43ad-8e13-8fcb82ea831a";
    ...
    protected com.just.agentweb.WebViewClient mWebViewClient = new com.just.agentweb.WebViewClient() {
	   ...
	   /* public void onMainFrameError(AbsAgentWebUIController agentWebUIController, WebView view, int errorCode, String description, String failingUrl) {
            ...
            Log.i(TAG, "WelfWebFragment onMainFrameError");
        ...
        public void onClick(View v) {
            ...
            switch (v.getId()) {
                case R.id.iv_back:
                    ...
                    if (!mAgentWeb.back()) {
                        WelfWebFragment.this.getActivity().finish();
                    }
                    break;
                case R.id.iv_finish:
                    WelfWebFragment.this.getActivity().finish();
    ...
    private PopupMenu.OnMenuItemClickListener mOnMenuItemClickListener = new PopupMenu.OnMenuItemClickListener() {
        ...
        public boolean onMenuItemClick(MenuItem item) {
            ...
            switch (item.getItemId()) {
                ...
                case R.id.copy:
                    if (mAgentWeb != null) {
                        toCopy(WelfWebFragment.this.getContext(), mAgentWeb.getWebCreator().getWebView().getUrl());
                    }
                    return true;
