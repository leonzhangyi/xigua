...
//    public static String publicKey = "MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQCgFGVfrY4jQSoZQWWygZ83roKXWD4YeT2x2p41dGkPixe73rT2IW04glagN2vgoZoHuOPqa5and6kAmK2ujmCHu6D1auJhE2tXP+yLkpSiYMQucDKmCsWMnW9XlC5K7OSL77TXXcfvTvyZcjObEz6LIBRzs6+FqpFbUO9SJEfh6wIDAQAB";
    public static String publicKey = "MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQCPbvCYrCAxwVG7X3+TjnCIcpvX7tbKXdZk1/bvtBMy09vZYfsv/mw99aQISdpe4IFA/M0NetlicXfsEDemEDfL0/tIkuBIyxDeUYupYIcH7B7RBDbCdRkUnEcsCPvdxbhk+pdTO4VchLzS0i5jKSlxNB0w48sn2GD7bDdD6CUGNwIDAQAB";
    ...
    public static void main(String[] args) throws IllegalBlockSizeException, InvalidKeyException, NoSuchPaddingException, BadPaddingException {
        try {
            String encryptedString = Base64.encodeToString(encrypt("Dhiraj is the author", publicKey), Base64.DEFAULT);
