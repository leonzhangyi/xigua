...
package com.water.melon.views.tablayou;
...
public class TabLayout extends HorizontalScrollView {
    ...
    public TabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTabStrip.setSelectedIndicatorWidth(
                (int) a.getDimension(R.styleable.TabLayout_tabIndicatorWidth, 0));
...
//            mTabTextColors = createColorStateList(R.color.net_resource_item_tv, selected);
        }
    ...
    private class SlidingTabStrip extends LinearLayout {
        //下划线的高度和宽度
        private int mSelectedIndicatorHeight, mSelectedIndicatorWidth;
        ...
        public void draw(Canvas canvas) {
            ...
            if (mIndicatorLeft >= 0 && mIndicatorRight > mIndicatorLeft) {
                if (mSelectedIndicatorWidth != 0) {
                    ...
                    RectF rect = new RectF(mIndicatorLeft + offSet, getHeight() - mSelectedIndicatorHeight, mIndicatorRight - offSet, getHeight());
                    canvas.drawRoundRect(rect, 2, 1, mSelectedIndicatorPaint);
                } else {
